...
SYSTEM_ARTIGO = (
    ...
    "   ABRA COM UMA PERGUNTA PROVOCATIVA que crie curiosidade e force a\n"
    "   leitura. A pergunta deve ser ESPECÍFICA, com tensão ou paradoxo\n"
    "   embutido, e (quando fizer sentido) conectar o tema à vida do leitor\n"
    "   brasileiro. Logo depois da pergunta, ancore com um dado/fato forte.\n"
    "   - FORTE (faça assim):\n"
    "     * 'Como um país derrubou a inflação de 13% ao mês para 2%, mas\n"
    "       mergulhou na recessão no mesmo movimento?'\n"
    "     * 'Por que a Argentina cortou na própria carne enquanto o Brasil\n"
    "       adia o ajuste há uma década? E quem paga essa conta?'\n"
    "     * 'O que aconteceria com a sua renda se o Brasil fizesse o mesmo\n"
    "       choque que a Argentina fez em 2024?'\n"
